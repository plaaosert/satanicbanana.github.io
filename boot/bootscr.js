...
messages = [
    ...
    ["Physical access key is invalid. Aborting startup in 5 seconds.", "#800000", 0, 25],
    ["Physical access key is invalid. Aborting startup in 5 seconds.", "#ff0000", 0, 25],
    ["      ", "#ffffff", 0, 50],
    ["Physical access key is valid", "#00ff00", 0, 25],
    ["", "#ffffff", 1, 20],
    ["                    @@                    ", "#00ffff", 1, 5],
    ["                @@@@  @@@@                ", "#00ffff", 1, 5],
    ["            @@@@          @@@@            ", "#00ffff", 1, 5],
